...
const Details = () => {
  ...
  const fetchData = async () => {
    try {
      const movie = await ky
        .get(
          `https://api.themoviedb.org/3/movie/${params.id}?api_key=836c908c992e085a541e9c67774163c7&language=fr-EU`
        )
        .json(); /* Récupère le film par ID */
      const actors = await ky
        .get(
          `https://api.themoviedb.org/3/movie/${params.id}/credits?api_key=836c908c992e085a541e9c67774163c7&language=fr-EU`
        )
        .json(); /* Récupère les acteurs par ID du film */
