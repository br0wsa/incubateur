  ...
  return (
    <>
      ...
      >
        ...
        <Heading level={1}>S'enregistrer</Heading>
        ...
        <Text>
          ...
          inscrire, vous recevrez un lien unique par e-mail ou par SMS. En
          cliquant sur ce lien, vous serez automatiquement inscrit à notre
